 ...
 * @evidenceExclude requirements/agent-authoring/deterministic-precomputation.md#agent-precomputed-closed-basis The one-shot creator publishes scaffold bytes and never runs a generator, seals a dependency basis, refuses a stale result, or separates derived output from external provenance; the generated project's own scripts and its builder own that ledger.
 ...
 * @evidenceExclude requirements/agent-authoring/reference-navigation.md#agent-reference-selection This argv adapter delegates initial project publication; it does not serve Markdown navigation requests or launch the repository's experimental sandbox.
 * @evidenceExclude requirements/agent-authoring/reference-navigation.md#agent-reference-source This argv adapter delegates initial project publication; it does not serve Markdown navigation requests or launch the repository's experimental sandbox.
 * @evidenceExclude requirements/agent-authoring/reference-navigation.md#agent-reference-bounds This argv adapter delegates initial project publication; it does not serve Markdown navigation requests or launch the repository's experimental sandbox.
 * @evidenceExclude requirements/agent-authoring/reference-navigation.md#agent-reference-isolation This argv adapter delegates initial project publication; it does not serve Markdown navigation requests or launch the repository's experimental sandbox.
 * @evidenceExclude requirements/agent-authoring/reference-navigation.md#agent-reference-transports This argv adapter delegates initial project publication; it does not serve Markdown navigation requests or launch the repository's experimental sandbox.
 * @evidenceExclude requirements/agent-authoring/project-ownership.md#agent-sandbox-write-boundary This argv adapter delegates initial project publication; it does not serve Markdown navigation requests or launch the repository's experimental sandbox.
 * @evidenceExclude specifications/authoring-and-authority/reference-navigation.md#spec-reference-selection This argv adapter delegates initial project publication; it does not serve Markdown navigation requests or launch the repository's experimental sandbox.
 * @evidenceExclude specifications/authoring-and-authority/reference-navigation.md#spec-reference-source This argv adapter delegates initial project publication; it does not serve Markdown navigation requests or launch the repository's experimental sandbox.
 * @evidenceExclude specifications/authoring-and-authority/reference-navigation.md#spec-reference-bounds This argv adapter delegates initial project publication; it does not serve Markdown navigation requests or launch the repository's experimental sandbox.
 * @evidenceExclude specifications/authoring-and-authority/reference-navigation.md#spec-reference-isolation This argv adapter delegates initial project publication; it does not serve Markdown navigation requests or launch the repository's experimental sandbox.
 * @evidenceExclude specifications/authoring-and-authority/reference-navigation.md#spec-reference-transports This argv adapter delegates initial project publication; it does not serve Markdown navigation requests or launch the repository's experimental sandbox.
 * @evidenceExclude specifications/authoring-and-authority/source-authority-and-derivation.md#spec-authoring-sandbox-physical-ownership This argv adapter delegates initial project publication; it does not serve Markdown navigation requests or launch the repository's experimental sandbox.
 */
