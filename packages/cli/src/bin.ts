 ...
 * @evidenceExclude specifications/interchange-and-adoption/resource-closure-and-acquisition.md#interchange-locator-redirect-fence The CLI dispatcher does not implement the interchange locator redirect fence system responsibility; it only routes explicit local commands and preserves delegated outcomes.
 * @evidenceExclude specifications/interchange-and-adoption/resource-closure-and-acquisition.md#interchange-media-dependency-extraction The CLI dispatcher does not implement the interchange media dependency extraction system responsibility; it only routes explicit local commands and preserves delegated outcomes.
 ...
 * @evidenceExclude requirements/external-inputs/resource-closure-and-acquisition.md#external-resource-location-boundary The CLI dispatcher does not implement the external resource location boundary requirement; it only routes explicit local commands and preserves delegated outcomes.
 * @evidenceExclude requirements/external-inputs/resource-closure-and-acquisition.md#external-resource-media-dependencies The CLI dispatcher does not implement the external resource media dependencies requirement; it only routes explicit local commands and preserves delegated outcomes.
