...
Commands:
  start <directory>   Create <directory> and lay down the blank scaffold:
                      production skill, typed source branches, deterministic
                      builder, local viewer, capture, tests, and evidence gates.
 ...
 * @evidence specifications/execution-and-recovery/retry-backoff-and-idempotency.md#execution-retry-eligibility-limit Routes retry through the generated eligibility and attempt-limit contract.
 ...
 * @evidence specifications/execution-and-recovery/state-machine-and-admission.md#execution-admission-decision Routes lifecycle commands through the generated admission decision and its explicit states.
 * @evidence specifications/execution-and-recovery/state-machine-and-admission.md#execution-allowed-state-transitions Delegates allowed transitions and their durable history to the generated render record.
 ...
 * @evidenceExclude requirements/external-inputs/source-selection-and-provider-neutrality.md#external-source-provider-neutrality Local legacy-file migration chooses no provider and therefore does not implement provider selection policy.
 ...
 * @evidence requirements/rendering/README.md#rendering-요구사항 Routes explicit planning, execution, verification, finalization, and recovery actions to the generated render host.
 * @evidence specifications/editorial-render-and-delivery/README.md#editorial-render와-delivery-system-specifications Dispatches exact scheduling and headless render lifecycle actions without reimplementing them.
 ...
 * @evidenceExclude specifications/interchange-and-adoption/intake-authority-and-routing.md#interchange-channel-independent-revision Migration accepts an explicit local legacy file rather than normalizing API, tool, and file channel revisions.
 * @evidenceExclude specifications/interchange-and-adoption/intake-authority-and-routing.md#interchange-provider-neutral-dispatch Local legacy-file migration invokes no provider and therefore implements no provider dispatch policy.
 ...
 * @evidenceExclude specifications/authoring-and-authority/source-authority-and-derivation.md#spec-authoring-change-impact-report The change-impact report is produced by the generated project's builder, not by the command that creates the project.
 * @evidenceExclude specifications/authoring-and-authority/source-authority-and-derivation.md#spec-authoring-derivation-output-lineage Output lineage is recorded by the builder over authored source; scaffolding writes template bytes and records none.
