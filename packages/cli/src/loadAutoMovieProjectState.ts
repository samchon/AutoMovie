 ...
 *
 * @evidence specifications/project/cli.md#portable-project-state-gates Verifies portable tracked state and compiler-owned bytes before an offline consumer uses them.
 */
