...
The generated [scaffold README](../template/scaffold/README.md#canonical-command-routes) owns the command inventory and explains when each route is applicable. This package README only shows the shortest entry sequence; it does not maintain a second command contract.
