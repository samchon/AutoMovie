...
Valid quarantine markers and their exact private evidence are inventoried as one GC candidate with combined reclaimable bytes. Apply removes the evidence first and its captured marker second; invalid marker content leaves private evidence outside automatic deletion, and duplicate references remain untouched for manual adjudication.
