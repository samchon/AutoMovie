...
The motion designs establish how contact targets, penetration, separation, and tolerance are measured for motions that touch or remain planted on another model.
