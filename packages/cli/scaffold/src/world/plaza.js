import { AutoMovieSubject, AutoMovieSubjectGroup, mergeAutoMovieSubjectContributions, worldSurfaceHeight, } from "@automovie/engine";
 ...
 */
export class WorldPiece extends AutoMovieSubject {
    /**
...
export class Plaza extends AutoMovieSubjectGroup {
    ...
    ground = new PlazaGround();
    mark = new PlazaCenterMark();
    haze = new PlazaHaze();
    members() {
     ...
     */
    design() {
        const placed = mergeAutoMovieSubjectContributions(this.members().map((piece) => piece.place()));
        return {
            id: this.id,
            units: "meter",
