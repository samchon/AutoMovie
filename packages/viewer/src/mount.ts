 ...
 * @evidenceExclude requirements/agent-authoring/mcp-boundary.md The viewer consumes compiled artifacts; agent instructions, authoring workflow, and source ownership remain outside this runtime.
 ...
 * @evidenceExclude requirements/review/alternative-takes-and-versions.md The viewer exposes observable frames; oracle policy, acceptance judgment, evidence adjudication, and review state remain outside this projection layer.
 * @evidenceExclude requirements/review/annotations-findings-and-verdicts.md The viewer exposes observable frames; oracle policy, acceptance judgment, evidence adjudication, and review state remain outside this projection layer.
 * @evidenceExclude requirements/review/approval-rejection-and-waivers.md The viewer exposes observable frames; oracle policy, acceptance judgment, evidence adjudication, and review state remain outside this projection layer.
 * @evidenceExclude requirements/review/criteria-and-comparison.md The viewer exposes observable frames; oracle policy, acceptance judgment, evidence adjudication, and review state remain outside this projection layer.
 * @evidenceExclude requirements/review/defect-classification.md The viewer exposes observable frames; oracle policy, acceptance judgment, evidence adjudication, and review state remain outside this projection layer.
 * @evidenceExclude requirements/review/frame-range-and-whole-work.md The viewer exposes observable frames; oracle policy, acceptance judgment, evidence adjudication, and review state remain outside this projection layer.
 ...
 * @evidenceExclude requirements/review/subject-inspection.md#review-observable-judgeable-parity The viewer opens a named subject and answers a pose with an image; which targets a user may ask a verdict on, and whether every such target has an observation unit, is decided outside this projection layer.
 ...
 * @evidenceExclude specifications/review-and-acceptance/subject-surface-and-inspection.md#review-system-subject-inspection-reach The viewer answers one pose with one image in process; the request surface that resolves a named target into a plan, keeps its artifacts out of the delivery bundle, and refuses by naming the missing instrument is the tool boundary above this projection layer.
 ...
 * @evidenceExclude specifications/review-and-acceptance/subject-surface-and-inspection.md#review-system-subject-propagation The viewer answers for one subject at one pose; propagating a confirmed defect to the frames and sibling placements it implicates is review state outside this projection layer.
