 ...
 * @evidenceExclude requirements/agent-authoring/reference-navigation.md#agent-reference-selection The viewer displays compiled scene inputs; it neither serves authored-Markdown reference requests nor launches repository sandboxes.
 * @evidenceExclude requirements/agent-authoring/reference-navigation.md#agent-reference-source The viewer displays compiled scene inputs; it neither serves authored-Markdown reference requests nor launches repository sandboxes.
