 ...
 */
export const acceptanceCriterionShots = (scenario) => {
...
export const acceptanceAddressesShot = (scenario, shot) => (scenario.target.kind === "shot" && scenario.target.id === shot) ||
    acceptanceCriterionShots(scenario).includes(shot);
//# sourceMappingURL=acceptanceScope.js.map