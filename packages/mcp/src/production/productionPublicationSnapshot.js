 ...
 */
export const productionPublicationInputFingerprint = (project) => {
    const generated = project.generatedManifest();
    if (generated === null)
        throw new Error("Terminal publication snapshot requires current compiler-owned output.");
    ...
    const reviews = new AutoMovieProductionReviewService(project, () => compiler).queue(compiler);
    return digestAutoMovieBytes(canonicalAutoMovieJsonBytes({
        ...snapshot,
...
//# sourceMappingURL=productionPublicationSnapshot.js.map