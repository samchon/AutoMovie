...
- `source`: additionally materialize primitive models and compact formation runtimes, bind and execute shot source, validate scenes, actor/object/formation motions, and shots, derive contract realizations, and enforce generated ownership.
...
Source output never self-certifies the contract. The compiler measures named-state predicates at the opening and closing times, event predicates at source-selected samples inside authoritative windows, camera subjects at review frames, and compact formation count/chunk/bounds/hero invariants. Passing realizations are written under `generated/realizations`; failure blocks every generated write.
