import { createAutoMovieArchetypeRegistry, } from "./archetypeRegistry";
 ...
 */
export const AUTOMOVIE_PRIMITIVE_ARCHETYPES = [STICKMAN_ARCHETYPE, PRIMITIVE_PROP_ARCHETYPE];
/** The shipped primitive catalogue, registered as one lookup. */
export const AUTOMOVIE_PRIMITIVE_ARCHETYPE_REGISTRY = createAutoMovieArchetypeRegistry(AUTOMOVIE_PRIMITIVE_ARCHETYPES);
//# sourceMappingURL=primitiveArchetypes.js.map