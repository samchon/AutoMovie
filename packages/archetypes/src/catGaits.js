const pairedUpper = (bone, phase, amplitude, duty) => ({
    bone,
    phase,
    duty,
    amplitude,
...
const pairedLower = (bone, phase, neutral, amplitude, duty) => ({
    bone,
    phase,
    duty,
    neutral,
...
const tail = (bone, phase, neutral, amplitude) => [
    {
        bone,
        axis: "abduction",
        phase,
...
//# sourceMappingURL=catGaits.js.map