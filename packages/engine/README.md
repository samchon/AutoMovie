...
| `service/` | 건물이 공급받는 배분 그래프의 검증과 lowering: port 매체·방향·단위 정합, 구간 간섭(run 전체가 아니라 직선 leg마다), 관통 슬리브를 뚫린 벽면의 두께와 외곽 안에 붙듦, 젖은 구역과 방수 범위, 배수의 유체 source/drain 결합, 유지보수 부피 |
