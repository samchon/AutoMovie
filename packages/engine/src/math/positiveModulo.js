 ...
 * @internal
 */
export const positiveModulo = (value, period) => {
 ...
 * @internal
 */
export const addPositiveModulo = (value, offset, period) => positiveModulo(positiveModulo(value, period) + positiveModulo(offset, period), period);
//# sourceMappingURL=positiveModulo.js.map