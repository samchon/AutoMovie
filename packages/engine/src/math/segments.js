...
const closestPointOnSegment = (point, start, end) => {
    ...
    const t = clamp01(Vector3.dot(Vector3.subtract(point, start), segment) / span);
    return Vector3.lerp(start, end, t);
};
/** Distance from `point` to segment `[start, end]`. */
export const pointSegmentDistance = (point, start, end) => Vector3.length(Vector3.subtract(point, closestPointOnSegment(point, start, end)));
/**
 ...
 * @author Samchon
 */
const closestSegmentPair = (a, b, c, d) => {
 ...
 * @author Samchon
 */
export const segmentSegmentDistance = (a, b, c, d) => {
 ...
 * @author Samchon
 */
export const closestPointsBetweenSegments = (a, b, c, d) => {
    const pair = closestSegmentPair(a, b, c, d);
    return {
        ...pair,
