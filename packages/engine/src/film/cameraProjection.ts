 ...
 * @evidencePart specifications/camera-light-and-visibility/visibility-and-image-space-observation.md#clv-clipping-clearance-evaluation::projection-convention Builds the six camera-local half-spaces from inverse-quaternion rotation, negative-Z depth, vertical half-FOV, and width-to-height aspect.
 * @evidencePart specifications/camera-light-and-visibility/visibility-and-image-space-observation.md#clv-clipping-clearance-evaluation::boundary-inclusion-tolerance Keeps equality with every half-space inside, so a segment touching a closed boundary still intersects.
 ...
 * @evidencePart specifications/camera-light-and-visibility/visibility-and-image-space-observation.md#clv-clipping-clearance-evaluation::geometry-bounds Takes the clip against the caller's current resolved world box rather than a proxy or a stale bound.
 ...
 * @evidencePart specifications/camera-light-and-visibility/visibility-and-image-space-observation.md#clv-clipping-clearance-evaluation::near-far-range Tests the sphere's radius-adjusted depth against the declared positive ordered near and far distances before its side-plane bounds.
