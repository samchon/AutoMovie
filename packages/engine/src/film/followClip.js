 ...
 * @author Samchon
 */
export const bakedTransformAt = (clip, node, t) => {
 ...
 */
export const bakedTransformFromClipsAt = (clips, node, t) => {
 ...
 * selector.
 */
const drivingStart = (clip, node) => clip.tracks.find((track) => track.channel.kind === "node" &&
    track.channel.node === node &&
    track.channel.path === "translation").times[0];
/**
 ...
 * @author Samchon
 */
export const followClipOf = (objectMotions, node) => {
    let best = null;
...
//# sourceMappingURL=followClip.js.map