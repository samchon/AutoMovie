...
export const resolveAffordanceSeat = (props) => {
    ...
    const contactPosition = Vector3.add(parent.translation, Quaternion.rotateVector(parent.rotation, frame.translation));
    ...
    const childRotation = Quaternion.multiply(contactRotation, Quaternion.inverse(child.frame.rotation));
    return {
        translation: Vector3.subtract(contactPosition, Quaternion.rotateVector(childRotation, child.frame.translation)),
        rotation: childRotation,
        scale: UNIT_SCALE,
    };
};
//# sourceMappingURL=resolveAffordanceSeat.js.map