 ...
 */
export const toRigAngle = (clinical, frame) => {
    if (clinical === null)
        return null;
 ...
 */
export const toClinicalAngle = (rig, frame) => {
    if (rig === null)
        return null;
    assertAxisFrame("rest frame", frame);
    return frame === undefined ? rig : frame.sign * rig + frame.neutral;
};
const shift = (axis, range, frame) => {
 ...
 * @author Samchon
 */
export const restRelativeConstraint = (clinical, frame) => ({
