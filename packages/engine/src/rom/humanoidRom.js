...
const constraint = (flexion, abduction, twist) => ({ flexion, abduction, twist });
const ballConstraint = (flexion, abduction, twist, swingDeg) => ({ flexion, abduction, twist, swingDeg });
/**
 ...
 * @author Samchon
 */
export const DEFAULT_HUMANOID_ROM = {
    // ── spine / head ──
    ...
    leftUpperArm: ballConstraint(range(-60, 180), range(-30, 180), range(-90, 90), 180),
    rightUpperArm: ballConstraint(range(-60, 180), range(-30, 180), range(-90, 90), 180),
    ...
    // ── legs ──
    leftUpperLeg: ballConstraint(range(-30, 120), range(-30, 45), range(-45, 45), 120),
    rightUpperLeg: ballConstraint(range(-30, 120), range(-30, 45), range(-45, 45), 120),
 ...
 * (unconstrained).
 */
export const getConstraint = (bone, override) => override ?? DEFAULT_HUMANOID_ROM[bone] ?? null;
//# sourceMappingURL=humanoidRom.js.map