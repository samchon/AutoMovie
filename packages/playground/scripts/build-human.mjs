...
const CACHE_DIR = "/tmp/automovie-makehuman-cache";
const BODY_STL =
...
const HERO_HAIR = HERO_HAIRS[process.env.AUTOMOVIE_HERO_HAIR ?? "bluntBangBob"];
if (!HERO_HAIR) throw new Error("Unknown AUTOMOVIE_HERO_HAIR");
