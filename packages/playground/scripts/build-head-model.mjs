...
const presets = {
  ...
  hero3: {
    ...
    values: {
      ...
      nostrilFlare: -0.8,
      mouthWidth: -0.15,
      mouthCornerTilt: 0.15,
      upperLipHeight: 0.1,
      lowerLipHeight: -0.35,
      upperLipFullness: 0.0,
      lowerLipFullness: -0.2,
      lipProjection: -0.95,
      earScale: 0.04,
    },
    targetMetrics: {
