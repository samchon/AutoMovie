 ...
 * @evidence specifications/asset-and-representation/facial-authoring/contract.md#face-spec-components Masks an additive body or target-depth loft by distance from the actual lining boundary and by the retained tip's depth support.
 */
