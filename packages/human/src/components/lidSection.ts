 ...
 * Both profiles use the same convex weights, so ordering cannot diverge between
 * the two anatomical owners. Role names and canthal blending belong to them.
 ...
 * @evidence specifications/asset-and-representation/facial-authoring/contract.md#face-spec-components Owns copied section witnesses and strictly ordered offsets under shared convex interpolation.
 */
