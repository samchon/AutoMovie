 ...
 * the frame rate — an {@link IAutoFilmSequence} cut-list. This is the editorial
 ...
 * @author Samchon
 */
export interface IAutoFilmAssembleApplication {
  process(props: IAutoFilmAssembleApplication.IProps): void;
}
export namespace IAutoFilmAssembleApplication {
