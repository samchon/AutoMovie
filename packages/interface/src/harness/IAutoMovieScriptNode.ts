 ...
 * diffusion side (D009); the text drives cut rhythm, viseme hints, and the
 ...
 * (D013), so it carries only the top-of-funnel decomposition.
 */
 ...
 * cross-cutting edges of the refinement graph (D013).
 */
...
/**
 * One node of the screenplay **refinement graph** (D013): the script is a tree
