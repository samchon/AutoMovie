import { IAutoMovieActionCall } from "./IAutoMovieActionCall";
 ...
 * @author Samchon
 */
export interface IAutoMoviePerformanceApplication {
  process(props: IAutoMoviePerformanceApplication.IProps): void;
}
export namespace IAutoMoviePerformanceApplication {
