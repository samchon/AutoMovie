 ...
 *
 * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-host-evidence Restricts context and geometry reads to explicit requests against the host's current project state.
