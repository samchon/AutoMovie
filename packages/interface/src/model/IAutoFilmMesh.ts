 ...
 *
 * Unlike a {@link AutoFilmPrimitiveShape} (a few LLM-emittable dimensions), a
 ...
 * @author Samchon
 */
export interface IAutoFilmMesh {
 ...
 * @author Samchon
 */
export interface IAutoFilmMeshSkin {
