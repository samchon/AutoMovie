 ...
 *
 * Where a raw {@link IAutoFilmMesh} is bulk vertex data (imported, not emittable
 ...
 * or prop from primitives is how autofilm generates geometry inside the
 ...
 * @author Samchon
 */
export type AutoFilmPrimitiveShape =
  | IAutoFilmBoxShape
  | IAutoFilmSphereShape
  | IAutoFilmCapsuleShape
  | IAutoFilmCylinderShape
  | IAutoFilmConeShape
  | IAutoFilmPlaneShape;

/** Axis-aligned rectangular box. */
export interface IAutoFilmBoxShape {
  /** Discriminator. */
  type: "box";
...
/** Sphere. */
export interface IAutoFilmSphereShape {
  /** Discriminator. */
  type: "sphere";
  /** Radius, meters. */
  radius: number;
...
export interface IAutoFilmCapsuleShape {
  /** Discriminator. */
  type: "capsule";
...
export interface IAutoFilmCylinderShape {
  /** Discriminator. */
  type: "cylinder";
  /** Radius, meters. */
  radius: number;
...
export interface IAutoFilmConeShape {
  /** Discriminator. */
  type: "cone";
  /** Base radius, meters. */
  radius: number;
...
export interface IAutoFilmPlaneShape {
  /** Discriminator. */
  type: "plane";
