import { IAutoFilmConstraintViolation } from "./IAutoFilmConstraintViolation";

/**
 * The result of running a autofilm artifact through the deterministic validator
 * tiers — success, or the full list of violations to feed back.
 *
 ...
 * @author Samchon
 */
export type IAutoFilmValidation =
  | IAutoFilmValidation.ISuccess
  | IAutoFilmValidation.IFailure;

export namespace IAutoFilmValidation {
  /** All tiers passed. */
