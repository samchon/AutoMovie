import { IMoticaConstraintViolation } from "./IMoticaConstraintViolation";

/**
 * The result of running a motica artifact through the deterministic validator
 ...
 * @author Samchon
 */
export type IMoticaValidation =
  | IMoticaValidation.ISuccess
  | IMoticaValidation.IFailure;

export namespace IMoticaValidation {
  /** All tiers passed. */
