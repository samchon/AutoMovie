...
import { IMoticaJointPose } from "./IMoticaJointPose";
...
export interface IMoticaPose {
   ...
   */
  root: IMoticaTransform | null;

  /**
   * The articulated joints. Sparse — only bones that leave their rest pose
   * appear. Each {@link IMoticaJointPose.bone} should appear at most once; the
