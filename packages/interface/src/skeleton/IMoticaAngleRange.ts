 ...
 * in degrees.
 *
 * This is the atom of motica's anatomical range-of-motion (ROM) model. The
 ...
 * correction. That is how motica makes "physically impossible poses are
 ...
 * @author Samchon
 */
export interface IMoticaAngleRange {
