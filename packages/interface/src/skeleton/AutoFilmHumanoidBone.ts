 ...
 *
 * This enum is the backbone of autofilm's "named scalar" strategy. Because
 ...
 * where direct LLM emission gets brittle. autofilm handles hands as a separate,
 ...
 * @author Samchon
 */
export type AutoFilmHumanoidBone =
  // ── torso (4) ──
