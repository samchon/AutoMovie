import { IAutoFilmBone } from "./IAutoFilmBone";
 ...
 * Because bones are keyed by the closed {@link AutoFilmHumanoidBone} enum, a
 * motion authored against one skeleton retargets onto any other that shares the
 * humanoid convention — the basis of autofilm's "author once, play on any VRM"
 * portability.
 *
 ...
 * @author Samchon
 */
export interface IAutoFilmSkeleton {
   ...
   * root) is required. Each {@link IAutoFilmBone.bone} appears at most once.
   */
  bones: IAutoFilmBone[];
}
