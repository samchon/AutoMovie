import { AutoFilmExpressionPreset } from "./AutoFilmExpressionPreset";
import { IAutoFilmBlendshapeChannel } from "./IAutoFilmBlendshapeChannel";

/**
 * A facial expression at one instant — coarse preset intent plus optional
 * fine-grained ARKit overrides.
 *
 * AutoFilm offers two registration levels so the model can work at whatever
 ...
 * @author Samchon
 */
export interface IAutoFilmExpression {
   ...
   * once.
   */
  blendshapes: IAutoFilmBlendshapeChannel[] | null;
}
