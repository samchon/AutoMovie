 ...
 * Audio2Face all target them, each in `[0, 1]`. For motica this is the ideal
 ...
 * verbatim, so a motica expression maps 1:1 onto any ARKit-compatible runtime.
 *
 ...
 * @author Samchon
 */
export type MoticaArkitChannel =
  // ── eyes (14) ──
  | "eyeBlinkLeft"
  | "eyeLookDownLeft"
  | "eyeLookInLeft"
