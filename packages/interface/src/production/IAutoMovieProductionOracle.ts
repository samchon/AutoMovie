 ...
 *
 * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-content-supply-refusal Exposes `IAutoMovieRenderBundleManifest` as the portable data boundary for the agent mcp content supply refusal requirement.
