 ...
 *
 * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-host-evidence Exposes `AutoMovieCaptureTarget` as the portable data boundary for the agent mcp host evidence requirement.
 ...
 *
 * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-contract-guidance Exposes `IAutoMovieCaptureReceipt` as the portable data boundary for the agent mcp contract guidance requirement.
...
export interface IAutoMovieCaptureReceipt {
   ...
   * Receipt format.
   *
   * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-contract-guidance Exposes `version` as the portable data boundary for the agent mcp contract guidance requirement.
   ...
   *
   * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-contract-guidance Exposes `productionId` as the portable data boundary for the agent mcp contract guidance requirement.
   ...
   *
   * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-contract-guidance Exposes `targetFingerprint` as the portable data boundary for the agent mcp contract guidance requirement.
   ...
   *
   * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-contract-guidance Exposes `rendererIdentity` as the portable data boundary for the agent mcp contract guidance requirement.
   ...
   *
   * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-contract-guidance Exposes `bundle` as the portable data boundary for the agent mcp contract guidance requirement.
   ...
   * Verified PNG digest.
   *
   * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-contract-guidance Exposes `outputDigest` as the portable data boundary for the agent mcp contract guidance requirement.
 ...
 *
 * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-host-evidence Exposes `IAutoMovieCaptureFrame` as the portable data boundary for the agent mcp host evidence requirement.
...
export interface IAutoMovieCaptureFrame {
   ...
   *
   * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-host-evidence Exposes `captured` as the portable data boundary for the agent mcp host evidence requirement.
   ...
   *
   * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-host-evidence Exposes `productionId` as the portable data boundary for the agent mcp host evidence requirement.
   ...
   *
   * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-host-evidence Exposes `reviewTarget` as the portable data boundary for the agent mcp host evidence requirement.
   ...
   *
   * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-host-evidence Exposes `receipt` as the portable data boundary for the agent mcp host evidence requirement.
   ...
   *
   * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-host-evidence Exposes `frame` as the portable data boundary for the agent mcp host evidence requirement.
   ...
   *
   * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-host-evidence Exposes `diagnostics` as the portable data boundary for the agent mcp host evidence requirement.
...
export namespace IAutoMovieCaptureFrame {
   ...
   *
   * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-host-evidence Exposes `IProps` as the portable data boundary for the agent mcp host evidence requirement.
  ...
  export interface IProps {
     ...
     *
     * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-host-evidence Exposes `target` as the portable data boundary for the agent mcp host evidence requirement.
     ...
     *
     * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-host-evidence Exposes `width` as the portable data boundary for the agent mcp host evidence requirement.
     ...
     *
     * @evidence requirements/agent-authoring/knowledge-boundary.md#agent-host-evidence Exposes `height` as the portable data boundary for the agent mcp host evidence requirement.
