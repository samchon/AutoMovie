 ...
 *
 * @evidence requirements/agent-authoring/mcp-boundary.md#agent-mcp-host-evidence Exposes `IAutoMovieAssetTurntableView` as the portable data boundary for the host evidence one asset review view carries.
...
export interface IAutoMovieAssetTurntableView {
   ...
   *
   * @evidence requirements/agent-authoring/mcp-boundary.md#agent-mcp-host-evidence Names which required view this host evidence answers for.
   ...
   *
   * @evidence requirements/agent-authoring/mcp-boundary.md#agent-mcp-host-evidence States the azimuth the host actually opened this view from.
   ...
   *
   * @evidence requirements/agent-authoring/mcp-boundary.md#agent-mcp-host-evidence States the elevation the host actually opened this view from.
   ...
   *
   * @evidence requirements/agent-authoring/mcp-boundary.md#agent-mcp-host-evidence States which rig pose this host evidence shows.
   ...
   *
   * @evidence requirements/agent-authoring/mcp-boundary.md#agent-mcp-host-evidence States which render pass this host evidence shows.
   ...
   *
   * @evidence requirements/agent-authoring/mcp-boundary.md#agent-mcp-host-evidence Points at the verified host pixels, or states that this view produced none.
 ...
 *
 * @evidence requirements/agent-authoring/mcp-boundary.md#agent-mcp-host-evidence Exposes `IAutoMovieCaptureTurntable` as the portable data boundary for the agent mcp host evidence requirement.
...
export interface IAutoMovieCaptureTurntable {
   ...
   *
   * @evidence requirements/agent-authoring/mcp-boundary.md#agent-mcp-host-evidence Exposes this field as the portable data boundary for the agent mcp host evidence requirement.
   ...
   *
   * @evidence requirements/agent-authoring/mcp-boundary.md#agent-mcp-host-evidence Exposes the refusal as the portable data boundary for the agent mcp host evidence requirement.
...
export namespace IAutoMovieCaptureTurntable {
   ...
   *
   * @evidence requirements/agent-authoring/mcp-boundary.md#agent-mcp-host-evidence Names the asset whose host evidence set is requested.
  ...
  export interface IProps {
     ...
     *
     * @evidence requirements/agent-authoring/mcp-boundary.md#agent-mcp-host-evidence Selects the production the host evidence is produced in.
     ...
     *
     * @evidence requirements/agent-authoring/mcp-boundary.md#agent-mcp-host-evidence Names the registry target the host opens.
     ...
     *
     * @evidence requirements/agent-authoring/mcp-boundary.md#agent-mcp-host-evidence Bounds the raster the host renders each view at.
