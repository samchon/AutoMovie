 ...
 * where autofilm meets a spatial host — including, longer term, **interia**: an
 * interia interior defines the room, and autofilm scene nodes place animated
 ...
 * @author Samchon
 */
export interface IAutoFilmSceneNode {
