 ...
 * where motica meets a spatial host — including, longer term, **interia**: an
 * interia interior defines the room, and motica scene nodes place animated
 ...
 * @author Samchon
 */
export interface IMoticaSceneNode {
