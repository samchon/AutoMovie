...
import { IMoticaChannelLimit } from "./IMoticaChannelLimit";
import { IMoticaDriver } from "./IMoticaDriver";
 ...
 * runtime, never a release. This is the mechanism that keeps motica additive
 ...
 * @author Samchon
 */
export interface IMoticaProfile {
  /** Stable id. */
  id: string;
  ...
  controls: IMoticaProfileControl[];
 ...
 */
export interface IMoticaProfileControl {
