import { AutoFilmInterpolation } from "./AutoFilmInterpolation";
 ...
 * target is any {@link IAutoFilmChannel} (node TRS, morph weights, or a
 ...
 * @author Samchon
 */
export interface IAutoFilmTrack {
  ...
  interpolation: AutoFilmInterpolation;
}
 ...
 * @author Samchon
 */
export interface IAutoFilmClip {
  /** Stable id. */
  id: string;
