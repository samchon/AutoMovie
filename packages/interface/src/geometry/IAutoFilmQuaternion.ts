 ...
 *
 * This is **engine / interchange representation, not LLM-facing**. autofilm
 ...
 * quaternions when converting a validated {@link IAutoFilmJointPose} into
 ...
 * @author Samchon
 */
export interface IAutoFilmQuaternion {
