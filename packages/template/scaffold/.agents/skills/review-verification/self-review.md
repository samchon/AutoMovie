...
3. Revise the smallest continuous span that makes the changed development natural and earned, then propagate it through scripts and screenplays.
...
This review does not replace evidence lint, evidence review or builder gates. When the complete production is ready to close, follow [Final whole-production review](review.md#final-whole-production-review), which owns that separate surface and its completion conditions.
