...
Searches, diffs, builder output, generated summaries, and earlier partial reads do not replace the full manifest read. A current fingerprint records one evidence check and does not prove production quality.
