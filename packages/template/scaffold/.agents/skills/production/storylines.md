...
Storylines belong only to a film. Write detailed narrative treatments in `docs/storylines` with ordered filenames and explicitly anchored `H2 sequence -> H3 scene -> H4 beat` identities.

## Scope

A storyline is a **detailed narrative treatment**. It is not a causal card, not a lore dump, not an event ledger, and not a preliminary screenplay. A careful reader holding only the settings and the treatment must be able to state what the film does and why it matters, before a scenario or a shot exists.

An H4 establishes its inherited condition, participants or active forces, material and social constraints, central event or formal operation, available choice or resistance where applicable, changed state, audience change, and bridge to what follows. Write enough particularity to make the development testable: who is present, who knows what, what is physically or institutionally possible, and how the chosen action changes what can follow. A recurring motif or returning subject acquires changed context or effect through use rather than reappearing as decoration.
...
Every H2, H3, and H4 answers the complete common, narrative, and storyline principle checklists and cites only settings it actually uses. The H2 population supplies every common, narrative, storyline, and treatment-population obligation owner, including `obligations/treatments.md#sustained-middle`, and covers its applicable discovery targets. Follow [Evidence staging](evidence-staging.md) for exact claim behavior. A later narrative change begins in the smallest true storyline owner and propagates through scenario, screenplay, shot, and film source.
