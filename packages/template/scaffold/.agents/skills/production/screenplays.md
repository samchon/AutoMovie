...
Screenplays belong only to a film. Mirror the reviewed script's ordered files and exact H2 sequence, H3 scene, and H4 beat identities in `docs/screenplays`.
...
Apply the narrative unit-addressability obligation across the population after drafting. If final expression reveals a hidden independent beat or an artificial split, repair the earliest treatment owner and propagate the new identity through script, screenplay, screenplay index, shots, and film source. Begin each H4 with audience-facing screenplay blocks rather than a treatment summary.
...
Every H2, H3, and H4 answers the complete common, narrative, and screenplay principle checklists, cites one exact script and one exact treatment unit at the same level, and cites only settings it uses. The H2 population supplies every common, narrative, and screenplay-obligation owner and covers its applicable discovery targets. Follow [Evidence staging](evidence-staging.md). After the final evidence review, continue with [Review](review.md).
