...
- Film relationships split by axis. Every script and screenplay H2/H3/H4 cites every treatment H2 it actually realizes, and the host union at each governed depth covers the complete treatment H2 population without exclusion. Every screenplay H2/H3/H4 additionally cites exactly one same-depth script parent, every script parent has one screenplay child, and only that script-to-screenplay delivery lineage has exact physical order and nesting.
