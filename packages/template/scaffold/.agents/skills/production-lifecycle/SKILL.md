...
Read [the complete production lifecycle](index.md), then the routed shape or phase document it names before authoring. [Evidence graph](../evidence-graph/SKILL.md) owns contract state, [source authoring](../source-authoring/SKILL.md) owns production TypeScript, and [review verification](../review-verification/SKILL.md) owns rendered judgment.
