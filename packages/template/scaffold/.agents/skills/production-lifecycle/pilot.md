...
Treatments are a flat ordered event population and own no delivery directory. During the pilot, author only the treatment events that the selected group realizes. Scripts design the delivery partition, construction screenplays inherit that exact group, and final screenplays mirror it. An uncited treatment event means the group does not realize the declared slice; repair the treatment selection or delivery boundary instead of excluding the event. This rule constrains which events exist yet, not how many script or screenplay units they become and not how much body each treatment receives.
...
2. take the selected script delivery group through review;
