...
This obligation owns semantic boundaries across each narrative layer. The narrative unit-identity principle owns exact identity between layers, and the common substantive-completion principle owns authored depth inside each addressed unit.
