<!--
@evidence principles/common.md#purpose-fit This file exists only to prove that the active settings graph accepts a fully paid disposable population and rejects a missing relationship.
@evidence principles/common.md#layer-boundary Every H2 states a compiler-calibration setting; none authors design, narrative, source implementation, or audience content.
@evidence principles/common.md#declared-basis The preamble and every status line declare these facts as disposable production inventions rather than external claims.
@evidence principles/common.md#production-language The complete file uses one consistent English calibration vocabulary for its repository-gate reader.
@evidence principles/settings.md#addressable-canon Delivery, aim, access, convention, review condition, domain coverage, and operative-subject accounting each have one independently addressable H2 owner.
@evidence principles/settings.md#information-structure Each H2 opens with status and one bounded statement of its owner, condition, and compiler consequence.
@evidence principles/settings.md#fact-status Every H2 explicitly labels its calibration fact as a production invention scoped to this disposable probe.
@evidence principles/settings.md#source-support The file makes no externally checkable production claim and attaches no external authority to its invented calibration facts.
@evidence principles/settings.md#capability-boundary The delivery scope explicitly excludes any delivered-subject or environment capability, leaving none for downstream source to guess.
@evidence principles/settings.md#constraint-sufficiency The seven owners bound the operator, observable diagnostic result, path and time units, operative subjects, and every excluded production domain.
@evidence principles/settings.md#observable-identity The file defines no delivered-subject, place, or audible identity and confines its only observable result to classified compiler diagnostics.
@evidence principles/settings.md#minimal-departure Only calibration-specific departures are authored; all unrelated production domains are explicitly outside this disposable delivery.
@evidence principles/settings.md#internal-coherence The declared repository-relative paths, millisecond time, sole operator, and diagnostic review condition describe one compatible result.
-->
...
@evidence obligations/common.md#machine-default Probe delivery scope states one calibration decision in plain declaratives, and the evenness it shares with its siblings is this probe's declared shape rather than an undecided default.
...
@evidence obligations/settings.md#delivery-scope This unit is the population owner that directly states the named settings role.
-->
...
@evidence obligations/common.md#machine-default Probe governing aim states one calibration decision in plain declaratives, and the evenness it shares with its siblings is this probe's declared shape rather than an undecided default.
...
@evidence obligations/common.md#machine-default Probe operator access states one calibration decision in plain declaratives, and the evenness it shares with its siblings is this probe's declared shape rather than an undecided default.
...
@evidence obligations/common.md#machine-default Probe coordinate and unit convention states one calibration decision in plain declaratives, and the evenness it shares with its siblings is this probe's declared shape rather than an undecided default.
...
@evidence obligations/common.md#machine-default Probe delivery review condition states one calibration decision in plain declaratives, and the evenness it shares with its siblings is this probe's declared shape rather than an undecided default.
...
@evidence obligations/common.md#machine-default Probe settings coverage map states one calibration decision in plain declaratives, and the evenness it shares with its siblings is this probe's declared shape rather than an undecided default.
...
Delivery, aim, operator access, coordinate convention, and review condition each have the separate owner above; every other production domain is outside this compiler calibration scope.
...
@evidence obligations/common.md#machine-default Probe operative subject inventory states one calibration decision in plain declaratives, and the evenness it shares with its siblings is this probe's declared shape rather than an undecided default.
