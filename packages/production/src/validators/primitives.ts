 ...
 * this module's surface for the rest of the validators.
 */
export {
  isRecord,
  pushViolation,
...
/**
 * Violation-collection primitives shared by the artifact validators and the
 * commit preconditions, the path-bearing building blocks every `$input...`
 * diagnostic is assembled from, plus the few validator-layer rules that more than one
