...
> => {
  ...
  if (
    ...
    throw new Error(
      `Repaint selection review for shot "${props.receipt.shot}" must name this candidate's exact attempt id and output digest. Review the generated candidate and full sequence before editing src/repaintSelectionReviews.ts and selecting it.`,
    );
