...
Place declared stems here. Audio timeline and final mux remain explicit production work; no provider call is hidden anywhere. Register every stem's byte-exact source, license, processing, and use in `automovie/assets.json`.
