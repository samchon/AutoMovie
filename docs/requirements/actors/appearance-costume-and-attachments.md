...
Base body, inner, outer, armor, accessory와 removable layer를 outfit, scene, damage와 phase에 따라 조합하고 서로 다른 costume version을 덮어쓰지 않아야 한다.
...
사용자가 제공한 model, texture, costume와 accessory를 direct use, native conversion 또는 group composition할 수 있고 source, license, digest와 actor consumer를 추적해야 한다.
