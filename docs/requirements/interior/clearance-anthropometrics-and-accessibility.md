# Clearance, 인체 치수와 접근성

## 사용자 Profile에 따른 공간 검토 {#interior-clearance-anthropometrics-accessibility}
...
### 연속된 Accessible Route {#interior-accessible-route}

Site와 exterior entrance에서 interior space, storey, mezzanine, fixture와 egress point까지 user profile에 맞는 연속 route를 검토하고 한 구간의 단절을 전체 접근 성공으로 숨기지 않아야 한다.

### Reach와 조작 {#interior-reach-operation}

Handle, switch, control, storage, fixture와 work surface의 height, reach depth, approach, force 또는 supported operation condition을 user profile과 state에 연결할 수 있어야 한다.

### 관할 Profile {#interior-jurisdiction-profile}
