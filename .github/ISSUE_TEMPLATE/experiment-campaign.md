...
about: Declare and record a reproducible external-agent benchmark
title: "experiment: "
labels: ""
assignees: ""
---
...
- Campaign id:
- Question:
- Launch authority and date, or `not authorized`:
- Repository and immutable head:
- Protocol and record revision:
- Claim ceiling:
- Closing condition:
