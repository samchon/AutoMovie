...
When reviewing a generated graph adapter, compare its emitted native configuration and authored declaration under the [native input projection contract](../../../docs/specifications/production-evidence/graph.md#spec-authoring-production-evidence-native-boundary). Use the installed native types and evaluator behavior to judge this boundary.
