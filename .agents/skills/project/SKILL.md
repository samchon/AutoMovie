...
- `packages/face` (`@automovie/face`): dormant parametric face/head/hair geometry, retained for compatibility and frozen by the likeness exclusion above. Do not extend it.
