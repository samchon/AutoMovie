 ...
 * @evidenceReview {@link Configuration.portraitEyeShape} #845cd1f Read the reserved attachment mode, aperture width and optical scale controls, the eye-owned pretarsal roll's cross-section and longitudinal weights, pigment endpoints and their consumers. These values select one authored assembly and do not certify likeness.
