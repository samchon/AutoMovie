 ...
 * @evidenceReview {@link Hair.buildPortraitHairProxy} #b6f8cd2 Read copied scalp/side attachment points, ellipsoid enclosure, forehead support, signed continuous hairline bias, ear clearance and finite metric checks. This remains an unfinished coarse proxy with no fibre simulation or detailed hair likeness claim.
