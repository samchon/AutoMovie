 ...
 * @evidenceReview {@link Anatomy.portraitNasalLayerFor} Read both branches and their shared layer identity. The omission test matches the original relief fields. The local-lobule trial selects an explicit empty control population so the old inflation is not added after the new sections; this activation choice does not establish acceptable alar form.
