 ...
 * @evidenceReview {@link Configuration.portraitEyeShape} #3df12d4 Read the reserved attachment mode, compact pretarsal/subtarsal profile, aperture width and optical scale controls, pigment endpoints and their consumers. These values select one authored assembly and do not certify likeness.
