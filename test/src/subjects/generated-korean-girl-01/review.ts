 ...
 * @evidenceReview {@link Configuration.portraitEyeShape} #2ec0afe Read the reserved attachment mode, aperture width and optical scale controls, the eye-owned pretarsal roll's cross-section and longitudinal weights, pigment endpoints and their consumers. These values select one authored assembly and do not certify likeness.
 * @evidence {@link Configuration.portraitHairShape} Selects the subject's continuous frontal hair-cap boundary fit.
 * @evidenceReview {@link Configuration.portraitHairShape} #6e08b93 Read the signed fringe bias beside both hair-proxy consumers and its focused boundary test. The value shifts one connected cap boundary within its transition band; it does not add a strand overlay or claim detailed grooming.
 ...
 * @evidenceReview {@link Configuration.portraitMouthShape} #691b8e3 Read the narrower fitted oral frame, reduced vermilion relief and the central-incisor mesial/distal cutting-edge contours beside the shared lip and dental consumers. The grouped settings do not replace the oral attachment frame.
 ...
 * @evidenceReview {@link Materials.createPortraitMaterials} #6ce5f12 Read the warmer rosy skin and softened vermilion albedos with their restrained roughness and clearcoat beside the material factory's copied records. This appearance-only change leaves component geometry and attachment topology to their separate owners.
 *
 ...
 * @evidenceReview {@link Hair.buildPortraitHairProxy} #37d9aad Read copied scalp/side attachment points, ellipsoid enclosure, forehead support, signed continuous hairline bias, ear clearance and finite metric checks. This remains an unfinished coarse proxy with no fibre simulation or detailed hair likeness claim.
 ...
 * @evidenceReview {@link Hair.IPortraitHairShape} #95a551e Read the finite bounded bias admission and its signed use in the one cap boundary beside the focused fringe test. The neutral omission remains symmetric and the optional fit does not create a second mesh.
 ...
 * @evidenceReview {@link Model.buildReferencePortrait} #7f7e9af Read foundation branching, control-net handoff, component assembly, final-skin ear/hair attachment and oral-contact application. The builder returns deterministic model data but does not turn passing construction checks into a likeness verdict.
 *
 ...
 * @evidenceReview {@link Eyebrows.portraitEyebrowProfile} #222877a Read the 0.05 mm radius, 0.0075 mm radius step, 0.58 taper, 0.03 mm clearance, 0.1 mm arch, 1.2 mm bend and five segments beside both default consumers. Eye creation copies this profile; these values are provisional rendering choices rather than measured hair data, and the enlarged fibres preserve a visible continuous brow at the captured close distance without changing the socket boundary.
 ...
 * @evidenceReview {@link Eyebrows.buildPortraitEyebrow} #022a11b Read owned profile admission, zero-population exit, binding checks, engine foremost-depth queries, central-difference normals and deterministic short upward/outward start/end fractions. The sloping-plane and translated-host scenarios retain normal clearance and geometry ownership; missing support and collapsed paths refuse. The local tangent construction is explicitly weaker than a general curved-mesh collision certificate.
 *
 ...
 * @evidence {@link Eyes.IPortraitAegyoSalShape} Groups the optional pretarsal roll's crest, shoulder and longitudinal weights under one eye-owned surface responsibility.
 * @evidenceReview {@link Eyes.IPortraitAegyoSalShape} #73d926b Read the copied optional object and its finite dimensions beside the lower-row replacement branch; omission retains the eyelid-only path and supplied values are not a detached overlay.
 * @evidence {@link Eyes.IPortraitAegyoSalShape.offset} Places the single pretarsal crest immediately below the lower-lid margin.
 * @evidenceReview {@link Eyes.IPortraitAegyoSalShape.offset} #3104b22 Read positive admission and the lower-row offset blend at both canthal fades.
 * @evidence {@link Eyes.IPortraitAegyoSalShape.projection} Sets the crest's anterior relief independently of its shoulder.
 * @evidenceReview {@link Eyes.IPortraitAegyoSalShape.projection} #5edb036 Read nonnegative admission and the crest-to-shoulder projection falloff in the eye rows.
 * @evidence {@link Eyes.IPortraitAegyoSalShape.width} Declares the authored transverse support width of the pretarsal body.
 * @evidenceReview {@link Eyes.IPortraitAegyoSalShape.width} #bffc50c Read positive admission beside the continuous lower section's horizontal extent.
 * @evidence {@link Eyes.IPortraitAegyoSalShape.height} Declares the crest-to-shoulder distance of the rounded roll.
 * @evidenceReview {@link Eyes.IPortraitAegyoSalShape.height} #b1f248b Read positive admission beside the rapidly fading shoulder offsets.
 * @evidence {@link Eyes.IPortraitAegyoSalShape.reach} Bounds the optional roll's authored support reach.
 * @evidenceReview {@link Eyes.IPortraitAegyoSalShape.reach} #a020b28 Read finite positive admission; it remains a section control and does not create a second skin surface.
 * @evidence {@link Eyes.IPortraitAegyoSalShape.weights} Carries optional medial-to-lateral prominence across the seven lower-lid witnesses.
 * @evidenceReview {@link Eyes.IPortraitAegyoSalShape.weights} #c6051bf Read the seven-value bounded copy and the canthal fade in the actual lower-row mapping.
