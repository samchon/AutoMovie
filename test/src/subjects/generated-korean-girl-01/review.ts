 ...
 * @evidenceReview {@link Configuration.portraitEyeShape} #293a737 Read the reserved attachment mode, aperture width and optical scale controls, the eye-owned pretarsal roll's cross-section and longitudinal weights, pigment endpoints and their consumers. These values select one authored assembly and do not certify likeness.
