...
export const test_cli_scaffold = async (): Promise<void> => {
  ...
  TestValidator.equals(
    ...
    [
      ...
      "docs/demo-film/02-treatment/SEQ-CUE.md",
      "docs/demo-film/03-beats/.gitkeep",
      "docs/demo-film/03-beats/BEAT-ANSWER-1.md",
      "docs/demo-film/03-beats/BEAT-CUE-1.md",
      ...
      "src/units/.gitkeep",
      "src/units/chorusHero.ts",
      "src/units/soloist.ts",
      "src/world/.gitkeep",
      "src/world/plaza.ts",
  ...
  TestValidator.equals(
    ...
    namedFacts([
      ...
      [
        "filesDocs2",
        () =>
          files["docs/demo-film/02-treatment/SEQ-CUE.md"]!.includes(
            "A soloist raises a hand",
          ),
      ],
    ]),
    {
