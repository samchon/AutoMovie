...
export const test_cli_scaffold = async (): Promise<void> => {
  ...
  TestValidator.equals(
    ...
    [
      ...
      "docs/characters/.gitkeep",
      "docs/characters/army.md",
      "docs/characters/sentinel.md",
      "docs/historical-notes.md",
      "docs/objects/.gitkeep",
      "docs/research/.gitkeep",
      "docs/world/.gitkeep",
      "docs/world/signal-field.md",
      "docs/demo-film/01-logline.md",
      "docs/demo-film/02-treatment/.gitkeep",
      "docs/demo-film/02-treatment/SEQ-ANSWER.md",
      "docs/demo-film/02-treatment/SEQ-SIGNAL.md",
      "docs/demo-film/03-beats/.gitkeep",
      "docs/demo-film/03-beats/BEAT-ANSWER-1.md",
      "docs/demo-film/03-beats/BEAT-SIGNAL-1.md",
      "docs/demo-film/04-scenes/.gitkeep",
      ...
      "src/units/.gitkeep",
      "src/units/armyHero.ts",
      "src/units/sentinel.ts",
      "src/world/.gitkeep",
      "src/world/signalField.ts",
  ...
  TestValidator.equals(
    ...
    namedFacts([
      ...
      [
        ...
        () =>
          files[".automovie/design/screenplay/index.json"]!.includes(
            '"path": "docs/demo-film/04-scenes/SCN-001.md"',
          ),
      ],
      [
        "filesDocs",
        () => files["docs/demo-film/04-scenes/SCN-001.md"]!.includes("SCN-001"),
      ],
      [
        "filesDocs2",
        () =>
          files["docs/demo-film/02-treatment/SEQ-SIGNAL.md"]!.includes(
