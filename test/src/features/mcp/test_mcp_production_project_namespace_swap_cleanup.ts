...
export const test_mcp_production_project_namespace_swap_cleanup = (): void => {
  ...
  TestValidator.equals(
    ...
    namedFacts([
      ...
      [
        "removedWithoutReplacementFailurePrimaryFailure",
        () => removedWithoutReplacement.failure === primaryFailure,
      ],
      [
        "removedWithoutReplacementOrderJoin",
        () =>
    ...
    ]),
    {
      ...
      removedWithoutReplacementFailurePrimaryFailure: true,
      removedWithoutReplacementOrderJoin: true,
