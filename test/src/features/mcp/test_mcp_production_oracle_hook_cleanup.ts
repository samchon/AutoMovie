...
export const test_mcp_production_oracle_hook_cleanup = (): void => {
  ...
  TestValidator.equals(
    ...
    namedFacts([
      ...
      [
        "standaloneFailureManifestFailure",
      ...
      ["selectiveMessageIncludes", () => selective.message.includes("hook-0")],
      ["selectiveMessageIncludes2", () => selective.message.includes("hook-2")],
      [
    ...
    ]),
    {
      ...
      standaloneFailureManifestFailure: true,
