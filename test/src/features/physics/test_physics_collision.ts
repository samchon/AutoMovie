 ...
 *
 * 1. Normal entry: segment (0,0,0)??10,0,0) crosses a sphere at (5,0,0) r=1 ?? *    first contact at x=4, parameter s=0.4.
 * 2. Clean miss ??null.
 ...
 * `projectileSphereHit`:
 *
 * 6. An arc launched at (0,0,0) with velocity (10,5,0) under g=(0,??0,0) passes
 *    through (10,0,0) at t=1; a unit sphere there is hit at ?늯=1.
