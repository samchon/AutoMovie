 ...
 * ?뭒 has no notion of "up". `lookRotation` must point ?뭒 down the requested
 ...
 *
 * 1. Straight ahead (?뭒) ??identity.
 * 2. Behind (+Z), pure sides (짹X) ??the 180째 family that leaves the w-trace.
