...
/** The parent placed off the origin and turned 90째 about +Y. */
 ...
 *    spans the shot.
 * 3. A moving parent (an elbow flexing 0 ??120째) carries the child: the baked
...
export const test_film_attach = (): void => {
  ...
  const motion = createValidMotion(); // leftLowerArm flexion 0 ??120째 over 1 s
