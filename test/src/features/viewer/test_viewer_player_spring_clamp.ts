 ...
 * let the render exceed the ROM the `clampToRom` constructor promise
 * guarantees: stiffness 100 / damping 5 stepping toward a 40° cap peaked at ≈
 * 58° (#1048). A joint vanishing from the sampled pose also hard-reset its
 * spring, popping follow-through to rest mid-swing.
 *
 * Scenarios:
 *
