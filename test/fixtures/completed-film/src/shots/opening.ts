 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The opening annotations name the exact screenplay scenes, source interfaces, camera, timing, and acceptance predicates, and the implementation fragment defineShot("opening", { scene: "opening-scene", contract: OPENING_CONTRACT, build: (context: IAutoMovieShotBuildContext) => buildCue(context, { openingAbduction: 0 is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on opening against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The answer annotations name the exact screenplay scenes, source interfaces, camera, timing, and acceptance predicates, and the implementation fragment defineShot("answer", { scene: "answer-scene", contract: ANSWER_CONTRACT, build: (context: IAutoMovieShotBuildContext) => buildCue(context, { openingAbduction is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on answer against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The openingAcceptance annotations name the exact screenplay scenes, source interfaces, camera, timing, and acceptance predicates, and the implementation fragment [ { id: '${opening.id}-beauty', evidence: [ { reason: "Beauty evidence verifies that the cue scene remains visually readable.", scene: "SCN-001", }, ], target: { kind: "shot" is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on openingAcceptance against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The answerAcceptance annotations name the exact screenplay scenes, source interfaces, camera, timing, and acceptance predicates, and the implementation fragment [ { id: '${answer.id}-beauty', evidence: [ { reason: "Beauty evidence verifies that the answering scene reads as a consequence.", scene: "SCN-002", }, ], target: { kind is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on answerAcceptance against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
