 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The film annotations name the reviewed shot intervals, screenplay sequences, and delivery endpoint, and the implementation fragment { build(context) { return { id: context.production.id, omissions: [], tracks: { video: [ { shot: "opening", sourceIn: { frame: 0 }, sourceOut: { seconds: 6 }, start: { frame: 0 is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on film against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
