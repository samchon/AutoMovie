 ...
 * @evidenceReview screenplays/001-cue/001-cue.md#seq-cue #6aeedd6 Read screenplays/001-cue/001-cue.md#seq-cue and film; confirmed the six-second opening fades up over its first twelve local frames, dissolves over its last twelve local frames, and carries the exact English caption from 1.5 through 3.0.
 ...
 * @evidenceReview screenplays/002-answer/001-answer.md#seq-answer #848767f Read screenplays/002-answer/001-answer.md#seq-answer and film; confirmed the six-second answer enters through the authored twelve-frame dissolve, holds its wide insert, and fades to black over its final twelve local frames.
 * @evidence obligations/delivery/film-sources.md#editorial-only-assembly Selects only the
 *   two reviewed shots and declares their twelve-frame overlap and fades.
