 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment id, leaf, hinge, width, silhouetteMargin, thickness, post, finish, color, metallic, roughness, openDeg, height, farEdgeZ, positiveEdgeX, position, hingeNode, model, design is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
...
export class PlazaGate extends AutoMovieSubject<IAutoMoviePropSpec> {
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.id annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment "plaza-gate" is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.id against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.leaf annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment "leaf" is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.leaf against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.hinge annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment "hinge" is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.hinge against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.width annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment 0.9 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.width against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.silhouetteMargin annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment 0.3 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.silhouetteMargin against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.thickness annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment 0.06 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.thickness against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.post annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment 0.12 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.post against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.finish annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment "gate-finish" is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.finish against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.color annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment "#6f746e" is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.color against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.metallic annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment 0 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.metallic against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.roughness annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment 0.82 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.roughness against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.openDeg annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment 100 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.openDeg against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.height annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment { return soloist.height + this.silhouetteMargin; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.height against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.farEdgeZ annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment { // Folded rather than spread into 'Math.min', because a world may carry more // vertices than an argument list holds and a ground large enough to matter // is exactly the one is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.farEdgeZ against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.positiveEdgeX annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment { let edge: number | null = null; for (const surface of context.world.surfaces) for (const vertex of surface.polygon) edge = edge === null ? vertex.x : Math.max(edge is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.positiveEdgeX against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.position annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment { return { x: this.positiveEdgeX(context) / 2, y: 0, z: this.farEdgeZ(context), }; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.position against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.hingeNode annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment { return placementChildNode(this.id, this.hinge); } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.hingeNode against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.design annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment { const half = (this.openDeg * Math.PI) / 360; const hinge: IAutoMovieNode = { id: this.hinge, name: null, parent: null, kind: "group", // The hanging edge, in the prop's own is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.design against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.stage annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment { return { node: this.id, model: this.id, position: this.position(context), facingDeg: 0, }; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.stage against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGate.render annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment { return { props: [this.design()], set: [this.stage(context)] }; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGate.render against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The gate annotations name the reviewed GATE structure, hinge, and placement decisions, and the implementation fragment new PlazaGate() is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on gate against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
