 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The SOLOIST_CUE_ABDUCTION annotations name the reviewed soloistCue motion inputs, channels, limits, and terminal state, and the implementation fragment 110 is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on SOLOIST_CUE_ABDUCTION against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The createSoloistCueMotion annotations name the reviewed soloistCue motion inputs, channels, limits, and terminal state, and the implementation fragment { const duration = props.duration; if (props.id.length === 0 || props.skeleton.length === 0) throw new Error("SOLOIST cue ids must be non-empty."); if is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on createSoloistCueMotion against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
