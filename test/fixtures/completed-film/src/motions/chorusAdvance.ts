 ...
 * @evidenceReview motions/020-chorus-advance.md #2487edf Read motions/020-chorus-advance.md and CHORUS_ADVANCE_METRES in src/motions/chorusAdvance.ts; confirmed this citation after checking the claim that the motion design fixes the whole formation's forward displacement at 2 m.
 ...
 * @evidenceReview principles/motion-sources.md#design-owned-transition #0815474 Read principles/motion-sources.md#design-owned-transition and CHORUS_ADVANCE_METRES in src/motions/chorusAdvance.ts; confirmed this citation after checking the claim that carries the exact displacement the cited motion design inherited from settings.
 */
 ...
 * @evidenceReview principles/motion-sources.md#design-owned-transition #0815474 Read principles/motion-sources.md#design-owned-transition and createChorusAdvanceMotion in src/motions/chorusAdvance.ts; confirmed this citation after checking the claim that implements only the cited advance endpoints and ease-in-out path.
 * @evidence principles/motion-sources.md#pure-time-mapping Maps explicit id,
