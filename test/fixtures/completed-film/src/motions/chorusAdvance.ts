 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The CHORUS_ADVANCE_METRES annotations name the reviewed chorusAdvance motion inputs, channels, limits, and terminal state, and the implementation fragment 2 is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on CHORUS_ADVANCE_METRES against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The createChorusAdvanceMotion annotations name the reviewed chorusAdvance motion inputs, channels, limits, and terminal state, and the implementation fragment { validateInterval(props); const held = { lateral: 1, depth: 1 }; return { id: props.id, formation: props.formation, action: "advance", gait: "walk", start: props.start, end is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on createChorusAdvanceMotion against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
