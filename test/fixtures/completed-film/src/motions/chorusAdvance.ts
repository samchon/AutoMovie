 ...
 * @evidenceReview obligations/design/motion-sources.md#design-owned-transition #5d64f23 Read obligations/design/motion-sources.md#design-owned-transition and CHORUS_ADVANCE_METRES in src/motions/chorusAdvance.ts; confirmed this citation after checking the claim that carries the exact displacement the cited motion design inherited from settings.
 */
 ...
 * @evidenceReview obligations/design/motion-sources.md#design-owned-transition #5d64f23 Read obligations/design/motion-sources.md#design-owned-transition and createChorusAdvanceMotion in src/motions/chorusAdvance.ts; confirmed this citation after checking the claim that implements only the cited advance endpoints and ease-in-out path.
 ...
 * @evidenceReview obligations/design/motion-sources.md#pure-time-mapping #3127ece Read obligations/design/motion-sources.md#pure-time-mapping and createChorusAdvanceMotion in src/motions/chorusAdvance.ts; confirmed explicit id, formation, start, and end values produce one deterministic time-addressed record while engine sampling stays outside the constructor.
 ...
 * @evidenceReview obligations/design/motion-sources.md#invalid-input-is-visible #5ce63ab Read obligations/design/motion-sources.md#invalid-input-is-visible and createChorusAdvanceMotion in src/motions/chorusAdvance.ts; confirmed that invalid identities and intervals fail before the function can construct a translated endpoint.
 */
