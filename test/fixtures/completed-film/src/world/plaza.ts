 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The WorldPiece annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment place, patches, design, render is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on WorldPiece against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
...
export abstract class WorldPiece extends AutoMovieSubject<IAutoMovieSubjectContribution> {
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The WorldPiece.place annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment IAutoMovieSubjectContribution is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on WorldPiece.place against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The WorldPiece.patches annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment { return []; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on WorldPiece.patches against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The WorldPiece.design annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment { return this.place(); } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on WorldPiece.design against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The WorldPiece.render annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment { return this.place(); } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on WorldPiece.render against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGround annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment id, margin, halfExtent, place, heightAt, patches is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGround against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
...
export class PlazaGround extends WorldPiece {
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGround.id annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment "ground" is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGround.id against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGround.margin annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment 1 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGround.margin against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGround.halfExtent annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment { return chorus.reach() + this.margin; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGround.halfExtent against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGround.place annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment { const half = this.halfExtent(); return { surfaces: [ { id: this.id, polygon: [ { x: -half, z: -half }, { x: half, z: -half }, { x: half, z: half }, { x: -half, z: half }, ] is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGround.place against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGround.heightAt annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment { return worldSurfaceHeight(this.place().surfaces![0]!, point); } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGround.heightAt against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaGround.patches annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment { const half = this.halfExtent(); return [ { id: this.id, kind: "floor", // Only 'x' and 'z' are read; the height comes from the anchor. polygon: [ { x: -half, y: 0, z: -half is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaGround.patches against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaCenterMark annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment id, radius, place is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaCenterMark against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
...
export class PlazaCenterMark extends WorldPiece {
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaCenterMark.id annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment "plaza-center" is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaCenterMark.id against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaCenterMark.radius annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment 3 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaCenterMark.radius against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaCenterMark.place annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment { return { landmarks: [ { id: this.id, position: { x: 0, y: 0, z: 0 }, radius: this.radius, meaning: "The readable center of the starter frame.", }, ], }; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaCenterMark.place against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaHaze annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment id, recipe, seed, place is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaHaze against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
...
export class PlazaHaze extends WorldPiece {
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaHaze.id annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment "plaza-haze" is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaHaze.id against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaHaze.recipe annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment "plaza-haze-smoke" is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaHaze.recipe against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaHaze.seed annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment 1416 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaHaze.seed against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The PlazaHaze.place annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment { return { effectRecipes: [ { id: this.recipe, kind: "smoke", seed: this.seed, emission: { rate: 40, burst: 64, duration: 4 }, particle: { lifetime: { min: 2, max: 4 }, size: { is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on PlazaHaze.place against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The Plaza annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment id, ground, mark, haze, members, space, design is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Plaza against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
...
> {
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Plaza.id annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment "starter-world" is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Plaza.id against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Plaza.ground annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment new PlazaGround() is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Plaza.ground against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Plaza.mark annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment new PlazaCenterMark() is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Plaza.mark against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Plaza.haze annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment new PlazaHaze() is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Plaza.haze against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Plaza.members annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment { return [this.ground, this.mark, this.haze]; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Plaza.members against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Plaza.space annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment { const surfaces = this.members().flatMap((piece) => [...piece.patches()]); return { id: '${this.id}-space', surfaces, walkable: surfaces.map((surface) => surface.id), }; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Plaza.space against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Plaza.design annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment { const placed = mergeAutoMovieSubjectContributions( this.members().map((piece) => piece.place()), ); return { id: this.id, units: "meter", landmarks: [...(placed.landmarks ?? is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Plaza.design against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The plaza annotations name the reviewed PLAZA composition, extent, atmosphere, and review decisions, and the implementation fragment new Plaza() is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread the citations carried on this binding rather than the ones on the class: each names the singleton relation itself, and none repeats the composition, extent, or neutral-review-view claims the `Plaza` declaration already answers.
