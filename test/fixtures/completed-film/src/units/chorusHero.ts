 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusMember annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment id, REFERENCE_HEIGHT_DELTA, SPECIFIED_HEIGHT, SCALE_TOLERANCE, height, headRadius, limbRadius, bodyColor, profile, design, render is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusMember against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
...
export class ChorusMember extends AutoMovieSubject<IAutoMovieModelRecipe> {
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusMember.id annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment "chorus-hero" is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusMember.id against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusMember.REFERENCE_HEIGHT_DELTA annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment 0.1 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusMember.REFERENCE_HEIGHT_DELTA against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusMember.SPECIFIED_HEIGHT annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment 1.7 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusMember.SPECIFIED_HEIGHT against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusMember.SCALE_TOLERANCE annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment 1e-9 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusMember.SCALE_TOLERANCE against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusMember.height annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment soloist.height - ChorusMember.REFERENCE_HEIGHT_DELTA is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusMember.height against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusMember.headRadius annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment 0.14 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusMember.headRadius against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusMember.limbRadius annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment 0.05 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusMember.limbRadius against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusMember.bodyColor annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment "#8f9d74" is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusMember.bodyColor against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusMember.profile annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { return chorusProfile(this.id); } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusMember.profile against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusMember.design annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { // Compared within a tolerance, not exactly. The height is a difference of // two authored metres, and a subtraction that lands a billionth away is the // float is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusMember.design against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusMember.render annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { return {}; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusMember.render against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The chorusHero annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment new ChorusMember() is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on chorusHero against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusTier annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment constructor, profile, design, render is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusTier against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
...
export class ChorusTier extends AutoMovieSubject<IAutoMovieModelRecipe> {
  public constructor(
     ...
     * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusTier.id annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment public readonly id: string is the concrete state or behavior by which this declaration establishes those relationships.
     * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusTier.id against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
     ...
     * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusTier.tier annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment public readonly tier: "near" | "far" is the concrete state or behavior by which this declaration establishes those relationships.
     * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusTier.tier against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
     ...
     * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusTier.headRadius annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment public readonly headRadius: number is the concrete state or behavior by which this declaration establishes those relationships.
     * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusTier.headRadius against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
     ...
     * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusTier.limbRadius annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment public readonly limbRadius: number is the concrete state or behavior by which this declaration establishes those relationships.
     * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusTier.limbRadius against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusTier.profile annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { return chorusProfile(this.id); } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusTier.profile against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusTier.design annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { if ( this.headRadius < chorusHero.headRadius || this.limbRadius < chorusHero.limbRadius ) throw new Error( 'docs/models/020-chorus.md requires the walk to read at every is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusTier.design against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The ChorusTier.render annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { return {}; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on ChorusTier.render against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The chorusNear annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment new ChorusTier("chorus-near", "near", 0.15, 0.065) is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on chorusNear against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The chorusFar annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment new ChorusTier("chorus-far", "far", 0.17, 0.085) is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on chorusFar against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
