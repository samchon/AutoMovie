 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The Soloist annotations name the reviewed SOLOIST model and articulation decisions, and the implementation fragment id, height, locomotionSpeed, design, cue, eyeHeight, skeleton, modelRef, render is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Soloist against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
...
export class Soloist extends AutoMovieSubject<IAutoMovieModelRecipe> {
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Soloist.id annotations name the reviewed SOLOIST model and articulation decisions, and the implementation fragment "soloist" is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Soloist.id against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Soloist.height annotations name the reviewed SOLOIST model and articulation decisions, and the implementation fragment 1.8 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Soloist.height against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Soloist.locomotionSpeed annotations name the reviewed SOLOIST model and articulation decisions, and the implementation fragment 1.2 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Soloist.locomotionSpeed against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Soloist.design annotations name the reviewed SOLOIST model and articulation decisions, and the implementation fragment { return { id: this.id, role: "performer", archetype: "stickman", parameters: { height: this.height, headRadius: 0.16, limbRadius: 0.06, }, palette: { body: "#d7b56d" }, lod is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Soloist.design against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Soloist.cue annotations name the reviewed SOLOIST model and articulation decisions, and the implementation fragment { return createSoloistCueMotion({ id: context.contract.id, duration: context.contract.durationSeconds, skeleton: this.skeleton(context), from: props.from, }); } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Soloist.cue against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Soloist.eyeHeight annotations name the reviewed SOLOIST model and articulation decisions, and the implementation fragment { return this.height * 0.9; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Soloist.eyeHeight against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Soloist.skeleton annotations name the reviewed SOLOIST model and articulation decisions, and the implementation fragment { const model = context.runtimeModels[this.id]; if (model === undefined || model.skeleton === null) throw new Error( 'The compiler-owned "${this.id}" stickman model must is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Soloist.skeleton against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Soloist.modelRef annotations name the reviewed SOLOIST model and articulation decisions, and the implementation fragment { const model = context.runtimeModels[this.id]; if (model === undefined) throw new Error( 'The compiler-owned "${this.id}" runtime model must be available.', ); return model.id; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Soloist.modelRef against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Soloist.render annotations name the reviewed SOLOIST model and articulation decisions, and the implementation fragment { return { actors: [ { node: this.id, model: this.id, speed: this.locomotionSpeed, eyeHeight: this.eyeHeight(), }, ], clips: [this.cue(context, { from: props.from ?? 0 })], }; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Soloist.render against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The soloist annotations name the reviewed SOLOIST model and articulation decisions, and the implementation fragment new Soloist() is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread the citations carried on this binding rather than the ones on the class: each names the singleton relation itself, and none restates a model or articulation claim that the `Soloist` declaration already answers a few hundred lines above.
