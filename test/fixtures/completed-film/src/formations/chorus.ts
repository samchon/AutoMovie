 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment id, count, ranks, files, spacing, seed, anchor, facingDeg, members, design, advance, hold, break, footprint, reach, render is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
...
> {
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.id annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment "chorus" is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.id against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.count annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment 2049 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.count against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.ranks annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment 33 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.ranks against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.files annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment 64 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.files against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.spacing annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { lateral: 0.5, depth: 1, } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.spacing against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.seed annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment 1415 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.seed against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.anchor annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { x: 0, y: 0, z: -5, } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.anchor against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.facingDeg annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment 180 is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.facingDeg against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.members annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { return [chorusHero]; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.members against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.design annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { const slots = this.ranks * this.files; if (this.count <= slots - this.files || this.count > slots) throw new Error( 'docs/models/020-chorus.md requires rows and columns is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.design against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.advance annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { return createChorusAdvanceMotion({ ...props, formation: this.id }); } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.advance against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.hold annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { return createChorusHoldMotion({ ...props, formation: this.id }); } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.hold against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.break annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { return createChorusBreakMotion({ ...props, formation: this.id }); } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.break against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.footprint annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { return { width: (this.files - 1) * this.spacing.lateral, depth: (this.ranks - 1) * this.spacing.depth, }; } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.footprint against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.reach annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { const footprint = this.footprint(); return Math.max( Math.abs(this.anchor.x) + footprint.width / 2, Math.abs(this.anchor.z) + footprint.depth + CHORUS_ADVANCE_METRES, ); } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.reach against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
   ...
   * @evidence principles/core/source-units.md#source-evidence-content-conformance The Chorus.render annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment { return super.render(context); } is the concrete state or behavior by which this declaration establishes those relationships.
   * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread every citation on Chorus.render against the whole declaration and its source-local calls; each stated parent, role, refusal, and result is present in code and no annotation claims a different owner.
 ...
 * @evidence principles/core/source-units.md#source-evidence-content-conformance The chorus annotations name the reviewed CHORUS model and formation decisions, and the implementation fragment new Chorus() is the concrete state or behavior by which this declaration establishes those relationships.
 * @evidenceReview principles/core/source-units.md#source-evidence-content-conformance #b63c520 I reread the citations carried on this binding rather than the ones on the class: each names the singleton relation itself, and none repeats the member-tier or formation-representation claims the `Chorus` declaration already answers.
